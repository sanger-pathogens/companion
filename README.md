...
1. Copy the new reference genome (FASTA) into `your-data/genomes`
1. Copy GFF3 and GAF files into `your-data/genomes`
1. Copy Augustus model files into `data/augustus/species/<species_name>/`
1. Create new directory `your-data/references/<short_name>/`
...
1 . Finally, change directory to `your-data/references` (you _must_ execute the following command in this directory)
